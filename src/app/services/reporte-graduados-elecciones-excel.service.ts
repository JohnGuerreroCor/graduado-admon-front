...
export class ReporteGraduadosEleccionesExcelService {
  logo: any;
  ...
  exportExcel(excelData: { title: any; headers: any; data: any }) {
    ...
    let worksheet = workbook.addWorksheet('ListadoGraduadosElecciones');
    worksheet.columns = [
      { width: 6 },
      { width: 15 },
      { width: 40 },
    ...
    titulo.value = 'Reporte: Listados de graduados para el proceso electoral';
    titulo.fill = {
      type: 'pattern',
      pattern: 'solid',
      fgColor: { argb: '8F141B' },
