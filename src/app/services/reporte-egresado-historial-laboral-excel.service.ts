...
export class ReporteEgresadoHistorialLaboralExcelService {
  logo: any;
  ...
  exportExcel(excelData: { title: any; headers: any; data: any }) {
    ...
    let worksheet = workbook.addWorksheet('HistorialLaboral');
    worksheet.columns = [
      { width: 10 },
      { width: 40 },
      { width: 40 },
    ...
    titulo.value = 'Reporte: Egresados Experiencia Laboral';
    titulo.fill = {
      type: 'pattern',
      pattern: 'solid',
      fgColor: { argb: '8F141B' },
