...
export class ReporteEgresadoPerfilProfesionalExcelService {
  logo: any;
  ...
  exportExcel(excelData: { title: any; headers: any; data: any }) {
    ...
    let worksheet = workbook.addWorksheet('PerfilProfesional');
    worksheet.columns = [
      { width: 10 },
      { width: 40 },
      { width: 40 },
    ...
    titulo.value = 'Reporte: Estudios realizados por egresados';
    titulo.fill = {
      type: 'pattern',
      pattern: 'solid',
      fgColor: { argb: '8F141B' },
