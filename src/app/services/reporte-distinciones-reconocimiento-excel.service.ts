...
export class ReporteDistincionesReconocimientoExcelService {
  logo: any;
  ...
  exportExcel(excelData: { title: any; headers: any; data: any }) {
    ...
    let worksheet = workbook.addWorksheet('DistincionesReconocimientos');
    worksheet.columns = [
      { width: 10 },
      { width: 40 },
      { width: 20 },
    ...
    titulo.value = 'Reporte: Distinciones y reconocimientos';
    titulo.fill = {
      type: 'pattern',
      pattern: 'solid',
      fgColor: { argb: '8F141B' },
