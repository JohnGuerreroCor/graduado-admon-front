...
@Component({
  selector: 'app-datos-personales-egresado',
  templateUrl: './datos-personales-egresado.component.html',
  styleUrls: ['./datos-personales-egresado.component.css'],
})
export class DatosPersonalesEgresadoComponent {
